...
$content['tips_contect']='<p>If you got any question please visit my <a target="_blank" href="http://www.redystyle.com/wechat">Online Help</a>. If you find any problem with this plugin please <a href="mailto:redy.ru@gmail.com">contact me</a>.';
...
if(stripos('-'.$locale,'zh')){
	...
	$content['tips_contect']='<p>如果你使用这个插件需要帮助请查看我的在<a target="_blank" href="http://www.redystyle.com/wechat">线帮助页面</a>，遇到任何问题，<a href="mailto:redy.ru@gmail.com">请联系我</a>。';
}
?>