...
$content['tips_contect']='<p>If you got any question please visit my <a target="_blank" href="http://www.redystyle.com/wechat">Online Help</a>. If you find any problem with this plugin please <a href="mailto:redy.ru@gmail.com">contact me</a>.</p><p>"URL Time Out" problem seems fixed. This problem mostly cause by "Server response too slow. If you still got this problem please <a href="mailto:redy.ru@gmail.com">contact and help me fix it</a>.</p>.';
...
if(stripos('-'.$locale,'zh')){
	...
	$content['tips_content']='<p>如果你使用这个插件需要帮助请查看我的在<a target="_blank" href="http://www.redystyle.com/wechat">线帮助页面</a>，遇到任何问题，<a href="mailto:redy.ru@gmail.com">请联系我</a>。</p><p>“请求URL超时”的问题看起来已经修复了，看起来这个问题大多数时候是服务器响应太慢导致的，如果你使用时仍旧遇到类似问题<a href="mailto:redy.ru@gmail.com">请帮助我一起调试</a></p>.';
}
?>